...
def fetch_data_from_sql():
    # Define a connection string with parameters for the database connection
    conn_str=(
        "Driver={ODBC Driver 17 for SQL Server};"  # Specify the driver for SQL Server
        "Server=DESKTOP-ULKMV2J\\SQLEXPRESS;" # SQL server instance
    ...
    # Excute the query and fetch the data into a DataFrame
...
def calculate_sentiment(review):
    # Get sentiment scores for review text
...
# Apply the sentiment analysis to calculate sentiment scores for each review
