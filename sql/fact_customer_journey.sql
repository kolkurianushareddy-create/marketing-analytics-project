--This query identifies duplicate records
--It cleans and standardize the data
-- It fills missing values using averages
...
WHERE 
    row_num = 1;  -- Keeps only the first occurrence of each duplicate group iden
